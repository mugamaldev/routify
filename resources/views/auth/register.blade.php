						...
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group"> 
									...
									@error('password') <div style="color:red;margin-top:5px;margin-bottom:5px;">{{ $message }}</div>@enderror
								</div>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group"> 
									...
									@error('password_confirmation') <div style="color:red;margin-top:5px;margin-bottom:5px;">{{$message}}</div>@enderror
								</div>
							</div>
						</div>
